...
<%@page import="java.text.SimpleDateFormat, java.util.HashMap, java.util.ArrayList, vn.fpt.edu.models.User, vn.fpt.edu.models.Category, java.sql.Date, vn.fpt.edu.admin.controller.DashboardController" %>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small"><%=((User)session.getAttribute("account")).getUser_name()%></span>
