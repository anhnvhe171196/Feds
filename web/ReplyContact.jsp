...
<body onload="time()">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                <a href="/Feds/feedbackListFeedbackController" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-hashtag me-2"></i>CONTACT</h3>
                </a>
    ...
    <div class="content">
                    ...
                    <table class="table text-start align-middle table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            <c:forEach items="${sessionScope.listContact}" var="list">
                                <tr>
                                    <td class="date-cell">${list.date}</td>
                                    ...
                                    <td>${list.suject}</td>
                                    <td>${list.message}</td>
                                    <c:if test="${list.status == 'Chưa gửi'}">
                                        <td class="center-cell">
                                            <button type="button" class="btn btn-outline-primary m-2 btn-center" onclick="openEmailDialog('${list.email}', '${list.suject}', '${list.contact_id}')">Gửi Email</button>
                                        </td>
                                    </c:if>
                                    <c:if test="${list.status != 'Chưa gửi'}">
                                        <td class="center-cell">
                                            <button type="button" class="btn btn-info rounded-pill m-2">Đã Gửi</button>
                                        </td>
                                    </c:if>    
                                </tr>
                            </c:forEach>
        ...
        <script>
                                            document.addEventListener("DOMContentLoaded", function () {
                                                ...
                                                dateCells.forEach(function (cell) {
                                                    var dateTimeStr = cell.textContent;
        ...
        <script>
            function openEmailDialog(email, subject, contact_id) {
                // Hiển thị dialog box
                    ...
                    <form action="sendEmailContact" method="post">
                        ...
                        <div class="mb-3">
                            <div class="modal-body">
                                ...
                                <p>Contactid: <span id="contact_id"></span></p>
                                <input type="hidden" id="contact_id-hidden" name="contact_id">
                                <div class="mb-3">
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                function updateHiddenFields() {
                    ...
                    var contactIdElement = document.getElementById('contact_id');
                    var contactIdHiddenInput = document.getElementById('contact_id-hidden');
                    ...
                    if (contactIdElement && contactIdHiddenInput) {
                        contactIdElement.addEventListener('DOMSubtreeModified', function () {
                            contactIdHiddenInput.value = contactIdElement.textContent;
                        });
                    }
                }
