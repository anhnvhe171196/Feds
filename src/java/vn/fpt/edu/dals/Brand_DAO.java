...
public class Brand_DAO extends DBContext {
    ...
    public HashMap<Brand, Integer> getAllBrandWithCount() {
        HashMap<Brand, Integer> list = new HashMap<>();
        String sql = "SELECT [Brand_Name], (SELECT Count(Product.Product_id) FROM Product join Brandd b on Product.Brand_id = b.Brand_Id WHERE b.Brand_Name = Brandd.[Brand_Name]) as Total\n" +
...
"  FROM [Brandd] GROUP BY Brand_Name ORDER BY Brand_Name";
    ...
    public HashMap<Brand, Integer> getAllBrandWithCate(String[] cateId) {
        HashMap<Brand, Integer> list = new HashMap<>();
        String sql = "SELECT \n" +
"    Brand_Name, (SELECT Count(Product.Product_id) FROM Product join Brandd b on Product.Brand_id = b.Brand_Id WHERE b.Brand_Name = Brandd.[Brand_Name]) as Total\n" +
"FROM \n" +
"    Brandd\n" +
"GROUP BY \n" +
"    Brand_Name\n" +
